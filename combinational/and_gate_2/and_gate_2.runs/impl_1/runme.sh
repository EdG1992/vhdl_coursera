...
HD_PWD='C:/Users/eddy/Documents/vhdl/vhdl_coursera/combinational/and_gate_2/and_gate_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log andGate2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source andGate2.tcl -notrace
