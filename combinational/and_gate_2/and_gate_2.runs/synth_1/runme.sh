...
HD_PWD='C:/Users/eddy/Documents/vhdl/vhdl_coursera/combinational/and_gate_2/and_gate_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log andGate2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source andGate2.tcl
